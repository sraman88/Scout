...
export function Footer() { return <div style={{ marginTop: 30, textAlign: "center", fontFamily: T.mono, fontSize: 10, color: T.text4, letterSpacing: 2 }}>SCOUT v3.1 · KEYS SYNCED TO YOUR ACCOUNT · BUILT FOR RECRUITERS WHO HUNT</div>; }
